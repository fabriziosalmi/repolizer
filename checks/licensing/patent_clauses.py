...
def run_check(repository: Dict[str, Any]) -> Dict[str, Any]:
    ...
    logger.debug(f"Starting patent clauses check for repository: {repo_name}")
    ...
    try:
        ...
        logger.debug(f"✅ Completed patent clauses check for {repo_name} with score: {final_result['score']}")
        return final_result
