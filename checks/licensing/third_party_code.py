...
def run_check(repository: Dict[str, Any]) -> Dict[str, Any]:
    ...
    logger.debug(f"Starting third-party code check for repository: {repo_name}")
    ...
    try:
        ...
        logger.debug(f"Completed third-party code check for {repo_name} with score: {final_result['score']}")
        return final_result
